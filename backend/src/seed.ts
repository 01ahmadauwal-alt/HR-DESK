...
async function seed() {
  ...
  // Departments
  const [engDept, hrDept] = await Department.create([
  ...
  // Link user → employee
  adminUser.employeeId = adminEmployee._id as mongoose.Types.ObjectId;
  ...
  hrUser.employeeId = hrEmployee._id as mongoose.Types.ObjectId;
  ...
  managerUser.employeeId = managerEmployee._id as mongoose.Types.ObjectId;
